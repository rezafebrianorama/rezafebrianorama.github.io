        ...
        <div class="col-lg-8 posts-list">
          ...
          <div class="navigation-top">
            <div class="d-sm-flex justify-content-between text-center">
              <p class="like-info"><span class="align-middle"><i class="fa fa-heart"></i></span> Lily and 4 people like
                this</p>
              <div class="col-sm-4 text-center my-2 my-sm-0">
                <p class="comment-count"><span class="align-middle"><i class="fa fa-comment-o"></i></span> 06 Comments</p>
              </div>
            ...
            <div class="navigation-area">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                  ...
                  <div class="arrow">
                    <a href="#">
                      <span class="fa fa-long-arrow-left text-white"></span>
                    </a>
                  </div>
                  <div class="detials">
                    <p>Prev Post</p>
          ...
          <div class="blog_right_sidebar">
            <aside class="single_sidebar_widget search_widget">
              <form action="#">
                ...
                <button class="button primary-btn w-100" type="submit">Search</button>
              </form>
            </aside>
            ...
            <aside class="single_sidebar_widget newsletter_widget">
              ...
              <form action="#">
                ...
                <button class="button primary-btn w-100" type="submit">Subscribe</button>
              </form>
            </aside>
          </div>
        </div>
